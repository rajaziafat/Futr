...
const Sidebar = () => {
  return (
    <div className="px-4 sm:px-0 mt-[12px] w-[112px] bg-[#FFFFFF] h-[calc(100vh-92px)] relative">
      <div>
        {/* Parent */}
        <div className="flex flex-col items-center mt-[20px] gap-[8px]">
          <div className="w-[31px] h-[32px] rounded-[4px] bg-[rgba(32,38,211,0.16)] flex items-center justify-center">
            <Image
              src="/aside/home.svg"
              alt="Home"
          ...
          <h4 className="text-[14px] font-normal sm:font-bold cursor-pointer text-[#2026D3]">
            Home
          </h4>
        </div>
        <div className="flex cursor-pointer flex-col items-center mt-[20px] gap-[8px] group">
          <div className="w-[31px] h-[32px] rounded-[4px] duration-75 group-hover:bg-[rgba(32,38,211,0.16)] flex items-center justify-center">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <h4 className="text-[14px] cursor-pointer font-normal sm:font-bold text-[rgba(99,115,129,1)] duration-75 group-hover:text-[#2026D3]">
            Dashboard
          </h4>
        </div>
        <div className="flex cursor-pointer flex-col items-center mt-[20px] gap-[8px] group">
