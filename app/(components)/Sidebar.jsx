    ...
    <div className="px-4 sm:px-0 mt-[12px] w-[112px] bg-white h-[calc(100vh-92px)] relative">
      <div>
        ...
        <div className="flex flex-col items-center mt-[20px] gap-[8px]">
          <div className="w-[31px] h-[32px] rounded-[4px] bg-lightBlue flex items-center justify-center">
            <Image
              src="/aside/home.svg"
              alt="Home"
          ...
          <h4 className="text-[14px] font-normal sm:font-bold cursor-pointer text-royalBlue">
            Home
          </h4>
        </div>
