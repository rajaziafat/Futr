        ...
        <table className="relative z-[1] min-w-full leading-normal">
          <thead>
            <tr className="border-b-2 border-borderDark">
              <th className="px-5 pt-2 pb-4  text-left text-[14px] font-semibold sm:font-bold text-slateGray uppercase tracking-wider"></th>
              <th className="px-5 pt-2 pb-4  text-left text-[14px] font-semibold sm:font-bold text-slateGray uppercase tracking-wider">
                Plant name
              </th>
              <th className="px-5 text-nowrap pt-2 pb-4 order-gray-200  text-left text-[14px] font-semibold sm:font-bold text-slateGray uppercase tracking-wider">
                DC capacity
              </th>
              <th className="px-5 pt-2 pb-4  text-left text-[14px] font-semibold sm:font-bold text-slateGray uppercase tracking-wider">
                Date
              ...
              <th className="px-5 pt-2 text-nowrap pb-4 order-gray-200  text-left text-[14px] font-semibold sm:font-bold text-slateGray uppercase tracking-wider">
                Inverter transformers
              </th>
              <th className="px-5 pt-2 pb-4 text-left text-[14px] group font-semibold sm:font-bold text-slateGray uppercase tracking-wider">
                <div className="relative">
                  ...
                  {openProject && (
                    <div className="w-[300px] absolute top-[130%] right-0 mt-1 bg-white rounded-md shadow-lg">
                      <label className="block px-4 py-2 font-normal text-[14px] text-slateGray cursor-pointer">
                        <input
                          type="radio"
                          name="project"
                          value="project1"
                      ...
                      <label className="block text-nowrap px-4 font-normal py-2 text-[14px] text-text-slateGray cursor-pointer">
                        <input
                          type="radio"
                          name="project"
                          value="project2"
          ...
          <tbody className="z-10">
            <tr className="border-b px-5 border-borderDark align-middle">
              ...
              <td className="px-5 pt-5 text-nowrap pb-2 text-[14px] text-slateNavy font-normal text-left">
                <div className="flex items-center gap-[12px]">
                  <p className="w-[16px] h-[16px] bg-purple rounded-[50%]"></p>
                  <span className="font-bold text-purple">On Project</span>
                </div>
              </td>
            ...
            <tr className="border-b px-5 border-borderDark align-middle">
              <td className="bg-white">
                <div className="w-[24px] h-[24px] flex items-center justify-center rounded-[50%] bg-shadeCoral">
                  <p className="text-sunsetCoral font-bold text-[14px]">1</p>
                </div>
              </td>
              <td className="px-5 text-nowrap pt-5 pb-2 text-[14px] font-normal">
                <p className="text-royalBlue whitespace-no-wrap">
              ...
              <td className="px-5 pt-5 pb-2 text-[14px] text-slateNavy font-normal text-left">
                <div className="flex items-center gap-[12px]">
                  <p className="w-[16px] h-[16px] bg-green rounded-[50%]"></p>
                  <span className="font-bold text-green">Available</span>
                </div>
              </td>
            ...
            <tr className="border-b px-5 border-borderDark align-middle">
              ...
              <td className="px-5 pt-5 pb-2 text-[14px] text-slateNavy font-normal text-left">
                <div className="flex items-center gap-[12px]">
                  <p className="w-[16px] h-[16px] bg-saffron rounded-[50%]"></p>
                  <span className="font-bold text-saffron">No Project</span>
                </div>
              </td>
            ...
            <tr className="border-b px-5 border-borderDark align-middle">
              ...
              <td className="px-5 text-nowrap pt-5 pb-2 text-[14px] text-slateNavy font-normal text-left">
                <div className="flex items-center gap-[12px]">
                  <p className="w-[16px] h-[16px] bg-purple rounded-[50%]"></p>
                  <span className="font-bold text-purple">On Project</span>
                </div>
            ...
            <tr className="border-b px-5 border-borderDark align-middle">
              ...
              <td className="px-5 pt-5 pb-2 text-[14px] text-slateNavy font-normal text-left">
                <div className="flex items-center gap-[12px]">
                  <p className="w-[16px] h-[16px] bg-slateGray rounded-[50%]"></p>
                  <span className="font-bold text-slateGray">Offline</span>
                </div>
              </td>
